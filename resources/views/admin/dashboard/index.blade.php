...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row g-6">
              ...
              <div class="row">
                  ...
                  <div class="col-6">
                      <div class="h-100 position-relative">
                          <img src="{{asset('backend/assets/img/illustrations/illustration-1.png')}}" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="95">
                      </div>
                  </div>
              </div>
          </div>
      ...
      <div class="col-xxl-3 col-sm-6">
          <div class="card">
              <div class="row">
                  ...
                  <div class="col-6">
                      <div class="h-100 position-relative">
                          <img src="{{asset('backend/assets/img/illustrations/illustration-2.png')}}" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="81">
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="card-body">
                  ...
                  <div class="bg-label-primary p-4 rounded my-3">
                      <div class="d-flex">
                          <div class="avatar flex-shrink-0 me-4">
                              <div class="avatar-initial bg-label-primary rounded">
                                  <div>
                                      <img src="{{asset('backend/assets/img/icons/unicons/briefcase.png')}}" alt="paypal">
                                  </div>
                              </div>
                          </div>
                  ...
                  <form id="paymentDetailsForm" onsubmit="return false">
                      ...
                      <div class="d-flex align-items-center mb-2">
                          <div class="me-3">
                              <img src="{{asset('backend/assets/img/icons/payments/logo-mastercard-small.png')}}" alt="credit card" height="30">
                          </div>
                      ...
                      <div class="d-flex align-items-center mb-2">
                          <div class="me-3">
                              <img src="{{asset('backend/assets/img/icons/payments/logo-credit-card-2.png')}}" alt="credit card" height="30">
                          </div>
                          <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                              <div>
                                  <h6 class="mb-1">Credit Card</h6>
          ...
          <div class="card h-100">
              ...
              <div class="card-body">
                  <ul class="p-0 m-0">
                      ...
                      <li class="d-flex mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                              <img src="{{asset('backend/assets/img/avatars/14.png')}}" alt="avatar" class="rounded-circle">
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                              <div class="me-2">
                      ...
                      <li class="d-flex mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                              <img src="{{asset('backend/assets/img/avatars/8.png')}}" alt="avatar" class="rounded-circle">
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                              <div class="me-2">
      ...
      <div class="col-xxl-4 col-md-6">
          <div class="card h-100">
              <img class="card-img-top h-px-200" src="{{asset('backend/assets/img/elements/laptop.png')}}" alt="laptop image cap" style="object-fit: cover;">
              <div class="card-body">
